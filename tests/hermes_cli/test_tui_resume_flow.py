...
def test_oneshot_waits_for_mcp_discovery_before_agent_init(monkeypatch):
    from hermes_cli.oneshot import _run_agent
    ...
    monkeypatch.setitem(
        ...
        mod("hermes_cli.mcp_startup", wait_for_mcp_discovery=lambda: state.__setitem__("waited", True)),
    )
